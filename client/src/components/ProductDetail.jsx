...
const ProductDetails = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto mt-20 px-6 py-8 bg-white rounded-lg shadow-md">
      ...
      {/* Instructions */}
      <div className="mb-8">
        <h2 className="text-2xl font-semibold text-green-700 mb-3">खास बातें</h2>
      ...
      <div className="mb-8">
        <h2 className="text-2xl font-semibold text-green-700 mb-3">दैनिक खुराक</h2>
      ...
      {/* Ingredients */}
      <div className="mb-8">
        <h2 className="text-2xl font-semibold text-green-700 mb-3">पशु आहार में उपयोग की गई सामग्री</h2>
        <ul className="list-disc list-inside text-gray-700 space-y-1">
       ...
       {/* Composition */}
       <div className="mb-8">
        <h2 className="text-2xl font-semibold text-green-700 mb-3">COMPOSITION</h2>
        <div className="overflow-x-auto">
          <table className="min-w-full bg-white border border-gray-300 rounded-lg shadow-sm">
            <thead className="bg-green-100 text-green-900">
              <tr>
            ...
            <tbody>
              {product.composition.map((compositions, index) => (
                <tr key={index} className="text-center text-gray-800 hover:bg-gray-100">
                  <td className="px-4 py-2 border font-medium">{compositions.ingredient}</td>
                  <td className="px-4 py-2 border">{compositions.specification}</td>
      ...
      <p className="text-lg text-red-600 font-medium mt-6 bg-red-50 p-4 rounded-md border border-red-200">
        <strong>Note:</strong> <ul className="list-disc list-inside text-gray-700 space-y-1">
