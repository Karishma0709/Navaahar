    ...
    <footer className="bg-primary text-white py-10 px-6 md:px-12">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          />
          <h2 className="font-bold text-lg mb-3 text-center md:text-left">
            About
          </h2>
          ...
          <ul className="space-y-2">
            <li className="flex flex-col md:flex-row items-center md:items-start md:gap-2">
              ...
              >
                ...
                Gurudwaraganj, Betul (M.P.) - 460001
              </a>
            </li>
            <li className="flex flex-col md:flex-row items-center md:items-start md:gap-2">
              <AiFillPhone className="text-xl mb-1 md:mb-0" />
              <a
                href="tel:+917415001555"
                className="hover:text-yellow-400 transition-all duration-300"
              >
                +91 74150 01555
              </a>
            ...
            <li className="flex flex-col md:flex-row items-center md:items-start md:gap-2">
              ...
              <a
                href="mailto:hr.navaahaar@betulbiofuel.com"
                className="hover:text-yellow-400 transition-all duration-300"
              >
